...
class Evento(models.Model):
    ...
    organizzatore = models.ForeignKey(Utente, on_delete=models.SET_NULL, related_name='eventi_organizzati', db_column='organizzatore_id', null=True, blank=True)
    iscritti = models.ManyToManyField(Utente, related_name='eventi_iscritti', blank=True, db_table='evento_iscritti')
